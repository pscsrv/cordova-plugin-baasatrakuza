                ...
                it('.tenant_id=undefinedの場合、正常に検索できること', function(done) {
                    ...
                    RKZClient.getNews(params,
                        function(news) {
                            ...
                            expect(news.attributes).toEqual(jasmine.objectContaining({"news_segment_flg":"0","news_segment_only_flg":"0","site_dir":"https://baas.raku-za.jp/stage/unittest/sdk.0210/","data_id":"26","readed_flg":"0","readed_dte":null,"tenant_name": "BaaS SDK テスト"}));
                            done();
                        }, function(error) {
                            expect(false).toBeTruthy(); done();  // Failed
                        });
                ...
                it('= undefinedの場合、条件未指定と同じように検索できること', function(done) {
                    ...
                    RKZClient.getNewsList(limit, searchConditions, sortConditions,
                        function(datas) {
                            ...
                            expect(datas[0].attributes).toEqual(jasmine.objectContaining({"news_segment_flg":"0","news_segment_only_flg":"0","site_dir":"https://baas.raku-za.jp/stage/unittest/sdk.0210/","data_id":"26","readed_flg":"0","readed_dte":null,"tenant_name": "BaaS SDK テスト"}));
                            done();
                        }, function(error) {
                            expect(true).toBeTruthy(); done();  // Failed
                        });
