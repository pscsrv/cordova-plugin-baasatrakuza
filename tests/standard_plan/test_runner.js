...
exports.suite = function(helper) {
    ...
    describe('BaaS@Rakuza for Cordova 結合テスト - Standard Plan (0230)', function() {
        ...
        require('./standard_plan/tests_user').suite(helper);
        require('./standard_plan/tests_application').suite(helper);
        ...
        describe('locale=jaの場合', function() {
            ...
            require('./standard_plan/tests_object_data').suite(helper);
            require('./standard_plan/tests_news').suite(helper);
            require('./standard_plan/tests_point').suite(helper);
            require('./standard_plan/tests_coupon').suite(helper);
            require('./standard_plan/tests_spot').suite(helper);
            require('./standard_plan/tests_stamp_rally').suite(helper);
            require('./standard_plan/tests_contact').suite(helper);
            require('./standard_plan/tests_beacon').suite(helper);
        });
